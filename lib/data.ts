...
const exam21: Question[] = [
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon DynamoDB is a fully managed NoSQL (non-relational) database service that does not require users to manage hardware or database software. Amazon RDS (A) and Aurora (C) are for relational databases, and Redshift (D) is for data warehousing, not general NoSQL. More details: https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/SQLtoNoSQL.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Regions are geographically separated and allow for disaster recovery and data replication across large distances. AWS Accounts (A) are for resource isolation, Availability Zones (C) are within a region, and Edge locations (D) are for content delivery, not disaster recovery. More details: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html",
  },
  {
    ...
    correctAnswers: [3, 4],
    explanation:
      "AWS Organizations enables consolidated billing (D) and governance enforcement (E) across multiple AWS accounts. It does not provide real-time communications (A), is not related to NoSQL databases (B), and while it can help with security governance, it does not provide automated security checks (C) directly. More details: https://aws.amazon.com/organizations/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS OpsWorks provides managed instances of Chef and Puppet for configuration management. AWS Config (A) tracks resource configuration, CloudFormation (C) is for infrastructure as code, and Systems Manager (D) is for operational management, not specifically Chef/Puppet. More details: https://aws.amazon.com/opsworks/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Consolidated billing allows multiple AWS accounts to be billed together under a single payer account. The other options are reporting tools, not billing combination mechanisms. More details: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "The AWS TCO Calculator helps estimate cost savings when migrating from on-premises to AWS. It does not provide monthly bill estimates (C), cost breakdowns (A), or billing alerts (D). More details: https://aws.amazon.com/tco-calculator/",
  },
  {
    ...
    correctAnswers: [1, 3],
    explanation:
      "AWS Direct Connect (B) and AWS VPN (D) provide secure network connectivity between on-premises networks and AWS VPCs. Route 53 (A) is DNS, Data Pipeline (C) is for data workflows, and Amazon Connect (E) is a contact center service. More details: https://aws.amazon.com/directconnect/faqs/",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "Customers are responsible for data encryption (A) and network/firewall configurations (C). AWS handles RDS patching (B), physical security (D), and compute capacity (E). More details: https://aws.amazon.com/compliance/shared-responsibility-model/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "The AWS Support API is available starting at the Business support plan. Developer and Basic do not include API access, and Enterprise is a higher tier than required. More details: https://aws.amazon.com/premiumsupport/plans/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Systems Manager allows automation of patching processes for EC2 instances, reducing manual effort. Option B is only for RDS, not EC2. Option A is manual and inefficient. Option C (AWS Config) is for compliance monitoring, not patching. More details: https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-patch.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Deploying EC2 instances across multiple Availability Zones in one AWS Region provides high availability and fault tolerance, as each AZ is isolated from failures in others. A single AZ (A) is a single point of failure. Multiple ENIs (B) do not provide AZ-level redundancy. Deploying across two regions (D) is not supported for a single EC2 deployment and adds complexity. Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Provisioning resources in the South America (São Paulo) Region brings infrastructure closer to Brazilian users, reducing latency. Direct Connect (A) is for private connectivity, not latency reduction for end users. Transit Gateway (C) is for VPC connectivity, not user routing. More EC2 in Sydney (D) does not address geographic latency. Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "On-Demand Instances are best for workloads that run only when needed, with no long-term commitment. Dedicated Instances (A) are for physical isolation, Spot Instances (B) can be interrupted, and Reserved Instances (D) are for steady-state usage. Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-on-demand-instances.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "The AWS Personal Health Dashboard provides real-time and proactive alerts for events that impact the user's AWS environment. The Service Health Dashboard (A) shows AWS-wide status, not account-specific. Trusted Advisor (C) is for best practices, and CloudWatch (D) is for monitoring resources. Reference: https://aws.amazon.com/premiumsupport/technology/personal-health-dashboard/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Storage Gateway integrates on-premises applications with AWS Cloud storage. AWS Backup (A) is for backup management, Connect (B) is a contact center, and Direct Connect (C) is for network connectivity, not storage. Reference: https://aws.amazon.com/storagegateway/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Security groups act as virtual firewalls for EC2 instances, controlling inbound and outbound traffic. Access keys (A) are for authentication, virtual private gateways (B) are for VPNs, and ACLs (D) operate at the subnet level, not instance level. Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-security-groups.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Transit Gateway enables scalable and efficient connectivity between on-premises environments and multiple VPCs across AWS Regions. Direct Connect (A) and VPN (B) are for single connections, and Client VPN (C) is for end-user VPN access. Reference: https://docs.aws.amazon.com/vpc/latest/tgw/what-is-transit-gateway.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "The Enterprise Support plan includes access to Senior Cloud Support Engineers and architectural reviews. Basic (A), Developer (C), and Business (B) do not provide the same level of support. Reference: https://aws.amazon.com/premiumsupport/plans/enterprise/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Organizations allows centralized control over account permissions, enforcing policies and access restrictions. Cognito (A) is for authentication, Shield (C) is for DDoS protection, and Firewall Manager (D) is for managing firewall rules. Reference: https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Artifact provides access to compliance-related reports and documentation. Marketplace (B) is for software procurement, Inspector (C) is for security assessment, and Support (D) is for technical support. Reference: https://aws.amazon.com/compliance/faq/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Amazon S3 One Zone-Infrequent Access is designed for infrequently accessed data that does not require multiple Availability Zone resilience but provides rapid access when needed. S3 Standard (A) is for frequently accessed data, Glacier Deep Archive (B) and Glacier (D) are for archival storage with slower retrieval. Reference: https://aws.amazon.com/s3/storage-classes/",
  },
  {
  ...
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "AWS CloudFormation and AWS OpsWorks enable infrastructure as code, allowing automation and management of AWS resources. CloudFront (B) is a CDN, Batch (C) is for batch computing, and QuickSight (E) is for analytics. Reference: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS CloudFormation allows you to replicate resources across AWS Regions by defining infrastructure as code. ElastiCache (A) is for caching, CloudTrail (C) is for logging, and Systems Manager (D) is for operations management. Reference: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-concepts.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS KMS provides encryption and key management for AWS CloudTrail logs, ensuring data security. Secrets Manager (A) is for secrets, Systems Manager (B) is for operations, and Certificate Manager (D) is for SSL/TLS certificates. Reference: https://docs.aws.amazon.com/awscloudtrail/latest/userguide/data-protection.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Elasticity in the AWS Cloud allows resources to scale up or down automatically based on demand, removing the need for capacity planning. The other options do not address capacity estimation. Reference: https://aws.amazon.com/what-is-cloud-computing/",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "Programmatic access to AWS requires an access key ID and a secret access key. The other options are not valid credential components for AWS API access. Reference: https://docs.aws.amazon.com/general/latest/gr/aws-sec-cred-types.html",
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "Amazon Lightsail and AWS Batch are compute services. Lightsail provides simple virtual private servers, while AWS Batch manages batch computing workloads. Systems Manager (B) is for operations, CloudFormation (C) is for infrastructure as code, and Inspector (E) is for security assessment. Reference: https://docs.aws.amazon.com/whitepapers/latest/aws-overview/compute-services.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Using separate AWS accounts for each department allows for clear cost allocation and management. Tags (A) help but are not as strict as account separation. VPCs (B) and Organizations (D) alone do not separate billing. Reference: https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Consolidated billing provides cost savings through combined usage volume discounts across multiple accounts. The other options are not direct benefits of consolidated billing. Reference: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Budgets allows users to set custom cost and usage limits and alerts them when thresholds are exceeded. AWS Organizations (A) is for account management, Cost Explorer (C) is for cost analysis, and Trusted Advisor (D) is for best practices and limits, not budget alerts. More details: https://aws.amazon.com/getting-started/hands-on/control-your-costs-free-tier-budgets/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Amazon Macie helps detect inadvertent data leaks of personally identifiable information (PII) and user credentials. GuardDuty (A) is for threat detection, Inspector (B) is for vulnerability assessment, and Shield (D) is for DDoS protection. More details: https://aws.amazon.com/macie/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Trusted Advisor provides insights into service limits and usage. TCO Calculator (A) is for cost comparison, Personal Health Dashboard (C) is for health events, and Cost and Usage report (D) is for billing. More details: https://aws.amazon.com/blogs/mt/monitoring-service-limits-with-trusted-advisor-and-amazon-cloudwatch/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "A hybrid cloud integrates workloads across both AWS and on-premises environments. VPN (A) is for connectivity, VPC (B) is an AWS network, and Private cloud (D) is on-premises only. More details: https://aws.amazon.com/hybrid/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "The principle of least privilege recommends granting only necessary permissions. Disabling console access (A) is not practical, generating secret keys for all users (B) is not secure, and storing credentials on EC2 (D) is a security risk. More details: https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Control Tower helps automate the setup and governance of multi-account AWS environments. The shared responsibility model (A) is a security framework, Security Hub (C) is for security posture, and Well-Architected Tool (D) is for architecture reviews. More details: https://aws.amazon.com/controltower/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Transit Gateway simplifies connectivity between multiple VPCs and on-premises networks. VPC peering (A) does not scale well, Direct Connect (C) is for private connectivity, and Global Accelerator (D) is for global application availability. More details: https://docs.aws.amazon.com/vpc/latest/tgw/what-is-transit-gateway.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Shield Advanced provides DDoS protection and support from AWS experts. Firewall Manager (B) manages firewall rules, WAF (C) is for web application firewall, and GuardDuty (D) is for threat detection. More details: https://docs.aws.amazon.com/waf/latest/developerguide/ddos-overview.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Spot Instances are the most cost-effective choice for applications with flexible schedules. On-Demand (A) is more expensive, Reserved (C) is for steady-state, and Dedicated Hosts (D) are for compliance. More details: https://aws.amazon.com/ec2/pricing/",
  },
  {
    ...
    correctAnswers: [3, 4],
    explanation:
      "Customers are responsible for securing their data in transit and ensuring data integrity. AWS is responsible for physical security, network devices, and storage decommissioning. More details: https://aws.amazon.com/compliance/shared-responsibility-model/",
  },
  {
...
const exam22: Question[] = [
  {
    ...
    correctAnswers: [0],
    explanation:
      "Using multiple AWS accounts is the recommended way to generate separate invoices for different environments, as each account receives its own bill. Resource tagging (B) helps with cost allocation but does not create separate invoices. Multiple VPCs (C) do not affect billing separation. Cost Explorer (D) is for analyzing costs, not for generating invoices. Reference: https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS CodePipeline is a fully managed CI/CD service that automates the application deployment process. AWS AppSync (A) is for building GraphQL APIs, AWS Batch (B) is for batch computing, and AWS DataSync (D) is for data transfer, not deployment. Reference: https://aws.amazon.com/codepipeline/",
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "Spot Instances (A) offer significant discounts for flexible workloads, and Reserved Instances (D) provide cost savings for predictable, long-term usage. Memory optimized instances (B) are for specific workloads, not cost reduction. On-Demand (C) is the most expensive for sustained workloads. AWS Budgets (E) helps monitor spending but does not reduce EC2 costs directly. Reference: https://aws.amazon.com/ec2/pricing/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Artifact provides on-demand access to AWS compliance reports and agreements. AWS Certificate Manager (A) manages SSL/TLS certificates, AWS Config (B) tracks resource configurations, and AWS CloudTrail (D) logs API calls, none of which provide compliance documentation. Reference: https://aws.amazon.com/artifact/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "Amazon Route 53 is a DNS service that can route user requests to endpoints in multiple AWS Regions, enabling cross-region traffic management. AppStream 2.0 (A) is for application streaming, VPC (B) is for networking, and Elastic Load Balancer (C) is for distributing traffic within a region, not across regions. Reference: https://aws.amazon.com/route53/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS CloudTrail records all API calls made within an AWS account, making it possible to track unauthorized access attempts. AWS Config (A) tracks resource configurations, Trusted Advisor (C) provides best practice checks, and Inspector (D) assesses security, but none log API calls. Reference: https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Config continuously monitors and records AWS resource configurations, supports compliance auditing, and can notify users of changes. Trusted Advisor (A) gives best practice recommendations, Resource Access Manager (C) shares resources, and Systems Manager (D) manages resources but does not audit compliance. Reference: https://aws.amazon.com/config/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Launching instances across multiple Availability Zones in the same Region increases availability and fault tolerance. Reserved Instances (B) are for cost savings, not availability. Multiple Regions (C) complicate management and do not guarantee high availability. Spot Instances (D) are for cost savings, not specifically for availability. Reference: https://aws.amazon.com/ec2/faqs/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon S3 cross-region replication (CRR) automatically copies objects to a bucket in another AWS Region for backup and compliance. CloudFront (A) caches content but does not back up data. AWS Backup (C) does not natively back up S3 buckets. S3 does not support snapshots (D). Reference: https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Budgets allows users to set custom cost thresholds and receive alerts when spending exceeds those limits. Cost Explorer (B) is for analyzing costs, Cost Allocation Tags (C) are for categorizing resources, and Organizations (D) is for account management, not for sending budget alerts. Reference: https://aws.amazon.com/aws-cost-management/aws-budgets/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Filling out the Penetration Testing Request Form is the recommended method to request penetration testing on AWS resources, ensuring compliance with AWS security policies. Opening a support case (A) is not the standard process, technical account managers (C) and sales representatives (D) do not handle penetration test requests. More details: https://aws.amazon.com/security/penetration-testing/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon Macie uses machine learning to automatically discover, classify, and protect sensitive data in Amazon S3. Amazon Inspector (A) is for security assessments, GuardDuty (C) is for threat detection, and Secrets Manager (D) is for managing secrets, not S3 data classification. More details: https://aws.amazon.com/macie/",
  },
  {
    ...
    correctAnswers: [2, 4],
    explanation:
      "A site-to-site VPN requires a Customer Gateway (on-premises) and a Virtual Private Gateway (on AWS). Internet gateway (A) is for internet access, NAT gateway (B) is for outbound internet traffic, and Transit Gateway (D) is for connecting VPCs, not for VPN termination. More details: https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "On-Demand Instances are ideal for unpredictable workloads that cannot tolerate interruptions. Spot Instances (A) can be interrupted, Dedicated Hosts (B) are for compliance, and Reserved Instances (D) are for predictable, long-term workloads. More details: https://aws.amazon.com/ec2/pricing/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "Loose coupling is the principle that reduces interdependencies between system components, improving scalability and fault tolerance. Scalability (A) is about growth, services not servers (B) is about abstraction, and removing single points of failure (C) is about redundancy. More details: https://docs.aws.amazon.com/wellarchitected/latest/framework/operational-excellence.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Security Bulletins provide the latest updates on security issues and advisories. Personal Health Dashboard (A) is for account-specific health, Secrets Manager (B) is for managing secrets, and Inspector (D) is for security assessments. More details: https://aws.amazon.com/security/security-bulletins/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Amazon EBS provides persistent block storage for EC2 instances, suitable for file systems. S3 (A) is object storage, EC2 instance store (B) is ephemeral, and ElastiCache (D) is for in-memory caching. More details: https://aws.amazon.com/ebs/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Tagging resources allows users to categorize and track costs for billing purposes. Limiting resource creation (B) is for access control, secondary payment methods (C) do not affect cost allocation, and using a single account (D) does not provide cost breakdowns. More details: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Artifact provides on-demand access to AWS security and compliance reports. GuardDuty (A) is for threat detection, Security Hub (B) aggregates security findings, and Shield (D) is for DDoS protection. More details: https://aws.amazon.com/artifact/",
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "AWS Lambda and Amazon DynamoDB are serverless services, meaning you do not manage servers or infrastructure. Elasticsearch Service (B), Elastic Beanstalk (C), and Redshift (E) require some level of server or cluster management. More details: https://aws.amazon.com/serverless/",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "AWS VPN and AWS Direct Connect both allow you to extend your on-premises data center to the AWS network. AWS VPN provides a secure encrypted tunnel, while Direct Connect offers a dedicated network connection. NAT gateway (B) is for outbound internet access, Amazon Connect (D) is a contact center service, and Route 53 (E) is DNS, not for network extension. More details: https://aws.amazon.com/directconnect/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "A member account must meet the requirements of a standalone account, including its own payment method, before it can be removed from AWS Organizations. SOC compliance (A) is not required, support cases (B) are not needed, and only the member account itself can complete the process, not just the payer (D). Reference: https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_remove.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "Scalability is the AWS benefit that allows applications to handle increasing or decreasing workloads by adding or removing resources. Elasticity (A) is closely related but refers to the ability to automatically adjust resources. Agility (B) is about speed of change, and Security (C) is about protection. Reference: https://aws.amazon.com/what-is-cloud-computing/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Artifact provides on-demand access to AWS compliance reports, including SOC 2. Personal Health Dashboard (A) is for health events, Trusted Advisor (B) gives best practice checks, and S3 (D) is object storage. Reference: https://aws.amazon.com/artifact/",
  },
  {
    ...
    correctAnswers: [1, 3],
    explanation:
      "Running workloads across multiple AWS Regions, or using another AWS Region as a disaster recovery site, ensures high availability and disaster recovery. Using only Availability Zones within a single Region (A, C) does not protect against regional failures. Reference: https://aws.amazon.com/blogs/startups/large-scale-disaster-recovery-using-aws-regions/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Snowball is designed for cost-effective, large-scale data transfer to AWS. Direct Connect (B) is for ongoing network connections, VPN (C) is not suitable for large data transfers, and S3 (D) is the storage destination, not a transfer service. Reference: https://aws.amazon.com/snowball/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Amazon RDS provides managed relational databases, including PostgreSQL, optimized for OLTP workloads. DynamoDB (A) is NoSQL, Athena (B) is for querying data in S3, and EMR (D) is for big data processing. Reference: https://aws.amazon.com/rds/postgresql/",
  },
  {
    ...
    correctAnswers: [0, 1],
    explanation:
      "Tagging resources and using multiple AWS accounts help allocate and identify costs by department. Account managers (C) and Trusted Advisor (D) do not directly allocate costs, and Consolidated Billing (E) aggregates costs but does not break them down by department. Reference: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-allocation-tags.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "The 'Principal' element in an S3 bucket policy specifies the user, account, or service allowed access. 'Action' (B) defines permitted operations, 'Resource' (C) specifies the object, and 'Statement' (D) is the policy block. Reference: https://docs.aws.amazon.com/AmazonS3/latest/userguide/amazon-s3-policy-elements.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Organizations enables consolidated billing and policy-based management for multiple AWS accounts, making cost management more effective. Trusted Advisor (B) provides recommendations, Direct Connect (C) is for networking, and Amazon Connect (D) is a contact center service. Reference: https://aws.amazon.com/organizations/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "On-Demand Instances are ideal for short-term, unpredictable, or trial workloads that cannot be interrupted, such as a one-month pilot. Reserved Instances (A) require a long-term commitment, Spot Instances (B) can be interrupted, and Dedicated Hosts (D) are for compliance or licensing needs. Reference: https://aws.amazon.com/ec2/pricing/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Cost Explorer provides forecasting capabilities based on historical usage, helping users predict future AWS costs. Support Center (A) is for support cases, TCO Calculator (B) estimates migration costs, and Simple Monthly Calculator (C) is for manual cost estimation. Reference: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-forecast.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS is responsible for patching and updating the hypervisor as part of its infrastructure security. Customers are responsible for patching their own operating systems and managing encryption and IAM policies. Reference: https://aws.amazon.com/compliance/shared-responsibility-model/?ref=wellarchitected",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Organizations allows the setup of a master payer account to consolidate billing across multiple AWS accounts. Budgets (A) is for cost tracking, Macie (B) is for data security, and QuickSight (C) is for analytics. Reference: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "The Operational Excellence pillar emphasizes performing operations as code to improve efficiency, consistency, and reduce human error. Performance efficiency (A), reliability (C), and security (D) are supported by other principles. Reference: https://aws.amazon.com/blogs/apn/the-5-pillars-of-the-aws-well-architected-framework/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Testing recovery procedures ensures systems can recover from failures efficiently, which is a key aspect of the reliability pillar. Vertical scaling (A) is about performance, manual recovery (B) and manual changes (D) are not best practices. Reference: https://aws.amazon.com/blogs/apn/the-5-pillars-of-the-aws-well-architected-framework/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Convertible Reserved Instances can be exchanged for other Convertible RIs of equal or greater value within the same region and instance family. They cannot be exchanged across regions (B), sold on the Marketplace (C), or have their term shortened by merging (D). Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ri-convertible-exchange.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Users are responsible for application-level configurations, such as routing traffic. AWS manages the infrastructure, physical security, and patching of infrastructure components. Reference: https://aws.amazon.com/compliance/shared-responsibility-model/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "The AWS Simple Monthly Calculator is designed to estimate the monthly cost of AWS architectures based on service usage. Support cases (A) are not for cost estimation, manual calculation (B) is error-prone, and the TCO Calculator (D) is for migration comparisons. Reference: https://docs.aws.amazon.com/pricing-calculator/latest/userguide/aws-pc.pdf",
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "Amazon RDS provides automated backups and software patching, reducing administrative overhead. Schema management (B) and indexing (C) are database features, not RDS-specific benefits. ETL management (E) is not a core RDS feature. Reference: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Welcome.html",
  },
  {
  ...
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon Redshift is a fully managed data warehouse service that consolidates data from multiple sources for analytics. DynamoDB (A) is a NoSQL database, Athena (C) is for querying data in S3, and QuickSight (D) is for data visualization. Reference: https://aws.amazon.com/redshift/faqs/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Config tracks configuration changes and evaluates compliance across AWS resources. CloudWatch (A) is for monitoring, CloudTrail (C) logs API calls, and Trusted Advisor (D) provides best practice checks. Reference: https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Elasticity allows AWS resources to scale up or down based on demand, reducing waste from underutilized infrastructure. High availability (A) is about uptime, security (C) is about protection, and loose coupling (D) is about system design. Reference: https://www.gremlin.com/blog/implementing-cost-saving-strategies-on-amazon-ec-2-with-chaos-engineering/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Reserved Instances provide significant discounts for long-term, steady-state workloads. On-Demand (A) is more expensive for long-term use, Dedicated Instances (C) are for compliance, and Spot Instances (D) can be interrupted. Reference: https://aws.amazon.com/ec2/pricing/reserved-instances/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "On-Demand Instances are best for short-term, unpredictable workloads that require guaranteed availability. Reserved Instances (B) are for long-term use, Dedicated Hosts (C) are for compliance, and Spot Instances (D) can be interrupted. Reference: https://aws.amazon.com/ec2/pricing/on-demand/",
  },
  {
    ...
    correctAnswers: [2, 3],
    explanation:
      "AWS Trusted Advisor helps optimize AWS usage by identifying underutilized resources and security vulnerabilities. It does not provide container orchestration (A), manage encryption keys (B), or enforce tagging (E). Reference: https://aws.amazon.com/about-aws/whats-new/2016/06/aws-support-enables-tagging-capabilities-for-trusted-advisor/",
  },
  {
    ...
    correctAnswers: [0, 4],
    explanation:
      "Following the principle of least privilege (A) and enforcing strong password policies (E) are AWS security best practices. Sharing root credentials (B) is never recommended, giving admin access (C) is not least privilege, and preventing password changes (D) is not secure. Reference: https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Snowball is designed for large-scale data migrations, capable of transferring petabytes of data. Storage Gateway (A) is for hybrid storage, Glacier Deep Archive (B) is for archival, and Lightsail (C) is for simple cloud hosting. Reference: https://docs.aws.amazon.com/snowball/latest/ug/transfer-petabytes.html",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon Redshift is AWS's data warehousing solution for fast analytics on structured data. EFS (A) is for file storage, RDS (C) is for relational databases, and VPC (D) is for networking. Reference: https://aws.amazon.com/redshift/",
  },
];
...
const exam23: Question[] = [
  {
    ...
    correctAnswers: [1],
    explanation:
      "Maintaining physical and environmental controls is the responsibility of AWS under the Shared Responsibility Model, as AWS manages the security of the cloud infrastructure. Patching the guest OS (A) and applications (D), as well as protecting communications and zone security (C), remain the customer's responsibility. More details: https://aws.amazon.com/compliance/shared-responsibility-model/",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "AWS Elastic Beanstalk and AWS OpsWorks are both designed to deploy and manage applications. Elastic Beanstalk automates deployment and scaling, while OpsWorks provides configuration management. AWS Config (B) is for compliance tracking, Application Discovery Service (D) is for migration assessment, and Kinesis (E) is for data streaming, not deployment. More details: https://d0.awsstatic.com/whitepapers/overview-of-deployment-options-on-aws.pdf",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Amazon Connect is a cloud-based contact center service that enables businesses to set up and operate customer service centers quickly. AWS Direct Connect (A) is for network connectivity, Support Center (C) is for support cases, and Managed Services (D) is for infrastructure management. More details: https://aws.amazon.com/connect/customers/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "The AWS Pricing Calculator allows anyone, even without an AWS account, to estimate costs for AWS services. Cost Explorer (A) and Budgets (C) require an AWS account, and TCO Calculator (B) is for comparing on-premises vs. AWS, not for detailed service pricing. More details: https://calculator.aws/#/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "An Internet gateway is required to allow inbound and outbound traffic between a VPC and the internet. NAT gateways (A) allow outbound-only access for private subnets, VPC endpoints (B) are for private AWS service connectivity, and VPN connections (C) are for secure site-to-site connections. More details: https://d1.awsstatic.com/whitepapers/aws-security-whitepaper.pdf",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Partial Upfront Reserved Instances provide significant cost savings for workloads that require continuous usage, such as a database server. Spot Instances (A) are cheaper but not suitable for persistent workloads due to interruptions. On-Demand (B) is flexible but more expensive, and No Upfront Reserved (D) offers less savings than Partial Upfront. More details: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-reserved-instances.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "Migrating to Amazon RDS and enabling Multi-AZ provides automatic failover and high availability for databases. An Application Load Balancer (A) does not provide database failover, EC2 Auto Recovery (B) only recovers the same instance, and termination protection (D) prevents accidental deletion but not outages. More details: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.MultiAZ.html",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "An AWS IAM account password policy allows administrators to enforce password complexity requirements for all users. IAM user policies (A) control permissions, SCPs (B) control account actions, and Security Hub (D) is for security monitoring, not password policies. More details: https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_passwords_account-policy.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Customers are responsible for patching the guest operating system and applications. AWS is responsible for the underlying infrastructure, including patching infrastructure (B), physical controls (C), and infrastructure device configuration (D). More details: https://aws.amazon.com/compliance/shared-responsibility-model/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "To deploy a PCI-compliant workload, you must use AWS services that are in-scope for PCI compliance and apply the necessary PCI controls at the application layer. Using any service (A, C) is not sufficient, and raising a support ticket (B, C) does not make a service PCI-compliant. More details: https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-pci-controls.html",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "Amazon SQS provides a managed message queuing service that supports FIFO queues, ensuring messages are processed in the exact order they are sent. Step Functions (A) is for workflow orchestration, SNS (B) is for pub/sub messaging, and Kinesis Data Streams (C) is for real-time data streaming, not guaranteed FIFO message queuing. Reference: https://aws.amazon.com/sqs/faqs/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Organizations allows companies to consolidate multiple AWS accounts under one billing structure, providing a single bill. The correct way is to send an invitation from the master account. The other options (A, B, D) are not valid methods for consolidated billing. Reference: https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/awsaccountbilling-aboutv2.pdf",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Budgets enables users to set custom cost and usage budgets with alerts when they exceed thresholds. Cost Explorer (A) is for cost analysis, Cost and Usage Report (C) is for detailed reporting, and CloudTrail (D) is for API activity logging. Reference: https://aws.amazon.com/getting-started/hands-on/control-your-costs-free-tier-budgets/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Elastic Beanstalk is a Platform as a Service (PaaS) solution that simplifies the deployment and scaling of applications, requiring minimal AWS knowledge. CloudFormation (A) and OpsWorks (D) require more configuration, and EC2 (C) requires manual setup and management. Reference: https://aws.amazon.com/elasticbeanstalk/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Trusted Advisor provides core security and performance-related checks for all AWS users. Full checks, including cost optimization and fault tolerance, are available only to Business and Enterprise Support plans. Reference: https://www.amazonaws.cn/en/support/trustedadvisor/faq/#checks",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "AWS Shield provides DDoS protection, while Amazon CloudFront helps mitigate attacks by caching content at edge locations and absorbing traffic. CloudTrail (B) is for logging, Support Center (D) is for support, and Service Health Dashboard (E) is for AWS service status, not DDoS protection. Reference: https://aws.amazon.com/shield/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Artifact provides access to AWS compliance reports, agreements, and certifications. AWS Config (A) is for resource configuration, GuardDuty (B) is for threat detection, and Trusted Advisor (C) is for best practices, not compliance reports. Reference: https://aws.amazon.com/artifact",
  },
  {
    ...
    correctAnswers: [1, 4],
    explanation:
      "Programmatic access should be granted to interact with AWS CLI and SDKs, while a least-privilege IAM policy with Amazon RDS access should be attached. Console access (A, C) is not required, and administrator access (D) violates least privilege. Reference: https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "AWS Config tracks AWS resource configuration changes and enables compliance auditing and remediation. Secrets Manager (B) is for secret storage, CloudTrail (C) is for API logging, and Trusted Advisor (D) is for best practices, not configuration compliance. Reference: https://aws.amazon.com/config/",
  },
  {
    ...
    correctAnswers: [0, 3],
    explanation:
      "Deploying across multiple Availability Zones improves fault tolerance and availability by preventing a single point of failure. It does not directly reduce costs (B), serve cross-region users (C), or increase load (E). Reference: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-increase-availability.html",
  },
  {
  ...
  {
    id: uuidv5("aws-question-1122", uuidv5.URL),
  ...
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Trusted Advisor helps users identify security vulnerabilities in an AWS account by providing security checks and best practice recommendations. Secrets Manager (A) is for managing secrets, Cognito (B) is for authentication, and Macie (C) is for data classification, not account-wide security checks. More details: https://www.coalfire.com/the-coalfire-blog/march-2019/aws-trusted-advisor-for-security-compliance",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Replicating workloads across multiple Availability Zones (AZs) ensures fault tolerance and high availability within a single AWS Region. Edge locations (A) are for content delivery, Regions (C) are for disaster recovery, and Route 53 (D) is DNS. More details: https://d36cz9buwru1tt.cloudfront.net/AWS_Building_Fault_Tolerant_Applications.pdf",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Amazon SNS enables applications to send messages via SMS and email. SES (B) is for email only, CloudWatch alerts (C) are for monitoring, and SQS (D) is for message queuing, not direct notifications. More details: https://aws.amazon.com/sns/faqs/",
  },
  {
    ...
    correctAnswers: [2, 4],
    explanation:
      "Testing recovery procedures and automatically recovering from failure increase system reliability. Monolithic architecture (A) reduces reliability, measuring efficiency (B) and adopting a consumption model (D) are not directly related to reliability. More details: https://wa.aws.amazon.com/wat.pillar.reliability.en.html",
  },
  {
    ...
    correctAnswers: [1, 3],
    explanation:
      "AWS Global Accelerator and Amazon CloudFront improve performance and reduce latency for global users. Application Load Balancer (A) is for distributing traffic within a region, Direct Connect (C) is for private connectivity, and Lambda (E) is for compute, not content delivery. More details: https://aws.amazon.com/cloudfront/faqs/",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS Direct Connect provides private, low-latency connections to AWS. VPN tunnels (A) use the public internet, public internet (B) is not private or low-latency, and VPC peering (C) is for connecting VPCs, not on-premises to AWS. More details: https://aws.amazon.com/getting-started/projects/connect-data-center-to-aws/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS Artifact provides access to compliance reports and agreements. Secrets Manager (A) is for secret storage, Security Hub (C) is for security posture, and Certificate Manager (D) is for SSL/TLS certificates. More details: https://aws.amazon.com/artifact/",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "AWS WAF (Web Application Firewall) helps protect web applications against SQL injection and cross-site scripting. GuardDuty (A) is for threat detection, Trusted Advisor (C) is for best practices, and Inspector (D) is for vulnerability assessment. More details: https://aws.amazon.com/waf/faq/",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Deploying instances in multiple Availability Zones ensures high availability. Deploying in a single AZ (B, C, D) creates a single point of failure. More details: https://www.betsol.com/blog/how-to-make-high-availability-web-applications-on-amazon-web-services/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "EC2 Reserved Instances provide significant savings for long-term workloads. Dedicated Instances (A) are for compliance, Spot Instances (B) are not suitable for steady-state workloads due to interruptions, and On-Demand (D) is more expensive for long-term use. More details: https://aws.amazon.com/choosing-a-cloud-platform/",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "The IAM credential report provides a detailed list of all IAM users and their credentials, including access keys and password status. This is the most efficient and secure way to provide this information. Granting admin access (A) is not secure, screenshots (B) are inefficient, and Trusted Advisor (D) does not provide a full credential report. [Reference](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_getting-report.html).",
  },
  {
    ...
    correctAnswers: [0, 2],
    explanation:
      "Consolidated billing allows organizations to manage multiple AWS accounts under a single bill and benefit from volume discounts. There is no extra fee (B), installment payments (D) are not a feature, and custom budgets (E) are managed with AWS Budgets, not consolidated billing. [Reference](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing.html).",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "On-Demand Instances are best suited for applications with unpredictable workloads that cannot tolerate interruptions. Spot Instances (B) can be interrupted, Reserved Instances (C) require long-term commitment, and Dedicated Hosts (D) are for compliance needs. [Reference](https://aws.amazon.com/ec2/faqs/).",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Config tracks AWS resource configuration changes and compliance status, making it ideal for compliance monitoring. Cost and Usage Report (A) is for billing, SCPs (B) are for account controls, and VPC Flow Logs (D) are for network traffic. [Reference](https://aws.amazon.com/config/).",
  },
  {
    ...
    correctAnswers: [0],
    explanation:
      "Amazon CloudFront is a global content delivery network (CDN) that caches content closer to users to reduce latency and improve speed. S3 cross-region replication (B) is for redundancy, VPN (C) and PrivateLink (D) are not for global content delivery. [Reference](https://aws.amazon.com/cloudfront/faqs/).",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "Following the principle of least privilege, IAM policies should be assigned only to users who require them, minimizing unnecessary permissions. Group size (A) and MFA (B) are good practices but not directly about least privilege, and multiple passwords (C) is not a best practice. [Reference](https://kirkpatrickprice.com/blog/best-practices-for-privilege-management-in-aws/).",
  },
  {
    ...
    correctAnswers: [3],
    explanation:
      "AWS benefits from economies of scale by purchasing infrastructure at large volumes, which allows it to reduce costs for customers. Pay-as-you-go (A) is about billing, high availability (B) is about uptime, and global reach (C) is about worldwide access. [Reference](https://innovationtactics.com/amazon-business-model-amazon-web-services/).",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS Transit Gateway enables organizations to efficiently connect multiple VPCs and simplify network management. VPC endpoints (A) are for private service access, Direct Connect (B) is for on-premises connectivity, and VPC peering (D) does not scale well for thousands of VPCs. [Reference](https://d1.awsstatic.com/whitepapers/building-a-scalable-and-secure-multi-vpc-aws-network-infrastructure.pdf).",
  },
  {
    ...
    correctAnswers: [1],
    explanation:
      "Auto Scaling allows applications to scale up or down based on demand, optimizing costs and performance. AWS does not refund cost differences (A), Spot Instances (C) are not automatic for all workloads, and CloudWatch (D) is for monitoring, not scaling. [Reference](https://aws.amazon.com/autoscaling/).",
  },
  {
    ...
    correctAnswers: [2],
    explanation:
      "AWS WAF helps protect web applications from SQL injection attacks and other common vulnerabilities. Security groups (A) and network ACLs (B) are for network access, and IAM policies (D) are for permissions, not web application security. [Reference](https://docs.aws.amazon.com/waf/latest/developerguide/classic-web-acl-sql-conditions.html).",
  },
];
